...
class RouteFinderIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        // @@NOG Liever zo connections.put("1", Set.of("52","73","73","233","264") );
    ...
    void findRoute() {
        ...
        //assertThat(route.size(), is( positive() ) );
        assertTrue( route.size() > 0 );

        Station station74  = underground.getNode( "74" );
        Station station99  = underground.getNode( "99" );
        Station station235 = underground.getNode( "235" );
        Station station146 = underground.getNode( "146" );
        Station station133 = underground.getNode( "133" );
        Station station107 = underground.getNode( "107" );
        Station station191 = underground.getNode( "191" );
        Station station276 = underground.getNode( "276" );
        Station station89  = underground.getNode( "89" );
        Station station145 = underground.getNode( "145" );
        Station station7   = underground.getNode( "7" );

        List<Station> expectedRoute = List.of( station74, station99, station235, station146, station133, station107, station191, station276, station89, station145, station7 );
